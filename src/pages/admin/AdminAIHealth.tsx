      ...
      >
        ...
        <div className="grid md:grid-cols-3 gap-4">
          <div className="p-4 rounded-lg bg-secondary/30">
            ...
            <p className="text-xs text-muted-foreground mt-1">Primary chat & reasoning model</p>
          ...
          <div className="p-4 rounded-lg bg-secondary/30">
            ...
            <p className="text-xs text-muted-foreground mt-1">Vision & prescription scanning</p>
            <div className="flex items-center gap-2 mt-2">
              <span className="w-2 h-2 rounded-full bg-success" />
              <span className="text-xs text-success">Active</span>
            </div>
          ...
          <div className="p-4 rounded-lg bg-secondary/30">
            <p className="font-medium">Custom LSTM</p>
            <p className="text-xs text-muted-foreground mt-1">Inventory demand forecasting</p>
            <div className="flex items-center gap-2 mt-2">
              <span className="w-2 h-2 rounded-full bg-success" />
              <span className="text-xs text-success">Active</span>
            </div>
